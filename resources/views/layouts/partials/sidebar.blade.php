...
<div class="col-2 col-sm-3 col-lg-2 bg-dark">
    <div class="d-flex flex-column justify-content-center align-items-center">
        <ul class="nav flex-column">
            <li
                class="nav-item {{ $controller == 'DashboardController' && in_array($action, ['index']) ? 'active' : '' }}">
            ...
            <li class="nav-item">
                <a href="#submenu1" class="nav-link btn text-white" data-bs-toggle="collapse" role="button"
                    aria-expanded="{{ $controller == 'UsersController' ? 'true' : 'false' }}"
                    aria-controls="submenu1">User
                    Management</a>
